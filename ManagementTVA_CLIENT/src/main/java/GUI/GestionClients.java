...
public class GestionClients extends JFrame {
	...
	public GestionClients() {
		...
		label.setFont(new Font("Roboto", label.getFont().getStyle(), label
				.getFont().getSize() + 4));
		...
		lblNom.setFont(new Font("Roboto", lblNom.getFont().getStyle(), lblNom
				.getFont().getSize() + 3));
		lblNom.setBounds(208, 142, 142, 41);
		panel.add(lblNom);

		JLabel lblNomResponsable = new JLabel("Nom Responsable");
		lblNomResponsable.setFont(new Font("Roboto", lblNomResponsable
				.getFont().getStyle(),
				lblNomResponsable.getFont().getSize() + 4));
		...
		lblEmail.setFont(new Font("Roboto", lblEmail.getFont().getStyle(),
				lblEmail.getFont().getSize() + 4));
		...
		lblTl.setFont(new Font("Roboto", lblTl.getFont().getStyle(), lblTl
				.getFont().getSize() + 4));
		...
		lblAdresse.setFont(new Font("Roboto", lblAdresse.getFont().getStyle(),
				lblAdresse.getFont().getSize() + 4));
